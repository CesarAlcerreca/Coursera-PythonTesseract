...
#Extracts the zips to new directories called 'small_img' and 'images'

try:
    os.mkdir('small_img') #Create directory called 'small_img'
except Exception:
...
try:
    os.mkdir('images') #Create directory called 'images'
except Exception:
    "Directory alrady created"
...
#Returns a randomly sorted list of the names of the images
pages_list=os.listdir('small_img')

#Global list contains lists with the path of each photo and the text inside it.
Global_list=[]
...
#Parameters in search, the text you are looking for and the directory we made in part 1 
